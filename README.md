...
3. Deploy, and send a userOp / txn through them
   1. Won't send an AA to ethereum (will send a txn through smart contract wallet)
...
> [!IMPORTANT]  
> This repo is for demo purposes only. Entire Readme is attributed to Cyfrin Updraft and Patrick Collins.
