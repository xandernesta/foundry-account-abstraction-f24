...
deployEth :; forge script script/DeployMinimal.s.sol --rpc-url arbitrum --sender ${ACCOUNT_MM} --account mm_sepolia --broadcast --verify -vvvv
...
sendUserOp :; forge script script/SendPackedUserOp.s.sol --rpc-url arbitrum --sender ${ACCOUNT_MM} --account mm_sepolia --broadcast -vvvv
